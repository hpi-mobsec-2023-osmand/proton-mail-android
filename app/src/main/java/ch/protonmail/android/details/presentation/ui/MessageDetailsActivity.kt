...
internal class MessageDetailsActivity : BaseStoragePermissionActivity() {
    ...
    private fun onLoadMessageBody(message: Message) {
        if (message.messageId != null) {
            viewModel.loadMessageBody(message).mapLatest { messageBodyState ->
                ...
                if (containsSpamKeywords(parsedBody, message.subject) || message.isPhishing()) {
    ...
    private fun containsSpamKeywords(decryptedMessage: String?, subject: String?): Boolean {
        val phishingTerms = arrayOf("Account Locked", "suspicious IP address", "Request for Account Update", "suspicious email tracking guideline", "suspicious email bounce", "Account Verification", "Request for Confidential Information", "Request for Personal Information", "suspicious email tracking standard", "suspicious email classification", "suspicious activity alert", "Account Monitoring", "Account Security", "Request for Account Advice", "suspicious email blacklist", "suspicious email tracking software", "Request for Urgent Response", "suspicious link redirect", "suspicious email marking", "spammer", "identity theft", "Request for Credit Card Information", "Account Approval", "fake domain", "suspicious email header", "suspicious email processing", "suspicious behavior", "suspicious email folder", "suspicious email content", "suspicious email tracking technique", "Account Updates", "Apple ID", "Confidential", "Request for Account Closure", "fraud", "Account Notifications", "Offer", "suspicious request", "Exclusive Offer", "suspicious email forwarding", "Update Your Security Settings", "suspicious email tracking functionality", "Request for Account Security Check", "Verify Your Account Details", "Payment Declined", "Request for Account Reactivation", "suspicious activity", "suspicious email domain", "Suspicious Sender", "Request for Assistance", "Unsubscribe", "suspicious login attempt", "Password Compromised", "Unusual Login", "Urgent Action Required", "Update Your Contact Information", "suspicious email whitelist", "Important", "suspicious email tracking system", "Account Restoration", "suspicious activity log", "Request for Account Access", "Confirm Your Transaction", "suspicious email block", "Verify Your Password", "Request for Account Changes", "Account Deletion", "suspicious website", "Request for Quick Reply", "suspicious email detection", "Change Your PIN", "suspicious email reporting", "suspicious email management", "Account Support", "Update Your Shipping Address", "suspicious source", "suspicious email quarantine", "suspicious email review", "Request for Account Updates", "suspicious email evaluation", "Request for Account Tracking", "Scam", "Amazon", "fraudulent", "suspicious transaction", "suspicious email filter", "Congratulations", "Update Your Payment Method", "Verify Your Login", "Request for Account Unblocking", "suspicious email labeling", "suspicious email tracking module", "Login Alert", "Account Upgrade", "suspicious phone number", "Warning", "Account Update", "Personal Information", "Account Management", "phishing email", "Change Your Privacy Settings", "suspicious email monitoring", "Security Breach", "Request for Account Notifications", "fake sender", "Cancel Your Order", "spam", "Account Reactivation", "Request for Account Announcements", "Account Access", "Request for Account Management", "Account Changes", "Request for Account Tips", "suspicious email report", "Update Your Recovery Options", "suspicious email analysis", "suspicious email tracking mechanism", "Account Alerts", "Confirm Your Purchase", "fake email", "suspicious email header analysis", "Hacked Account", "Verify Your Account", "Request for Account Suspension", "suspicious email tracking strategy", "Bank Account Update", "Request for Account Information", "suspicious email tracking feature", "Confirm Your Order", "Account Guidance", "Change Your Password", "Request for Account Help", "unsolicited", "Account Recommendations", "Request for Urgent Help", "hoax", "suspicious email tracking procedure", "Limited Time Offer", "Fraudulent", "Account Termination", "suspicious email tracking policy", "suspicious file", "Account Advice", "Account Checkup", "suspicious email signature", "phishing", "Urgent", "Suspicious Email", "Request for Verification", "malicious", "suspicious email categorization", "suspicious email sender", "Request for Account Termination", "Reactivate Your Account", "Verify Your Phone Number", "Suspicious Link", "Request for Payment", "Request for Account Assistance", "Request for Account Suggestions", "Password Reset", "suspicious content", "Confirm Your Identity", "suspicious email tracking tool", "suspicious website warning", "Sale", "Prize", "suspicious download", "Account Closure", "Request for Account Monitoring", "Request for Account Maintenance", "suspicious pattern", "Change Your Phone Number", "Account Assistance", "Account Reminders", "suspicious link", "suspicious login", "Verify Your Email", "Confirm Your Subscription", "Request for Account Alerts", "suspicious email investigation", "Request for Account Review", "suspicious email handling", "Request for Account News", "Reset Your Password", "fake", "suspicious attachment", "Account Tips", "suspicious email format", "Account News", "Account Maintenance", "Request for Account Activation", "Account Tracking", "Free", "Netflix", "Request for Account Verification", "suspicious email tracking algorithm", "suspicious sender", "Request for Social Security Number", "Request for Bank Details", "Update Your Security Questions", "Phishing Attempt", "Change Your Account Information", "Account Announcements", "Account Blocked", "Account Modification", "suspicious email subject", "suspicious email", "suspicious email notification", "suspicious email sampling", "suspicious email scanning", "Deactivate Your Account", "fraudulent activity", "Change Your Email Address", "Request for Account Guidance", "security", "Change Your Notification Preferences", "Account Security Check", "Social Security Number", "Account Suggestions", "suspicious domain", "Request for Account Approval", "Request for Immediate Attention", "Request for Account Downgrade", "Request for Account Modification", "suspicious", "Request for Account Restoration", "suspicious email attachment", "suspicious email tracking method", "suspicious email tracking database", "phishing website", "Account Confirmation", "deceptive", "Suspicious Attachment", "suspicious email tagging", "Request for Login Credentials", "PayPal", "Security Alert", "Request for Account Confirmation", "Credit Card Information", "suspicious email filtering", "suspicious email tracking process", "Account Activation", "Account Help", "suspicious email checking", "Suspicious Domain", "suspicious email archive", "suspicious email tracking protocol", "Account Compromise", "Account Downgrade", "Request for Account Support", "Request for Account Upgrade", "Suspicious Website", "Request for Account Recommendations", "Request for Account Reminders", "suspicious email tracking approach", "suspicious email validation", "suspicious login location", "Verify Your Payment", "phishing attempt", "Discount", "Change Your Security Settings", "Request for Urgent Action", "scam", "spoof", "suspicious email scoring", "suspicious email tagging system", "Account Unblocking", "suspicious email verification", "suspicious email tracking workflow", "Request for Account Deletion", "suspicious email flag", "Account Suspension", "Verify Your Billing Information", "Microsoft", "Lottery", "Confirm Your Password", "Change Your Username", "Request for Account Checkup", "Suspicious Activity", "Verify Your Identity", "suspicious message", "suspicious email tracking", "Request for Account Recovery", "suspicious email response", "Update Your Profile")
        var phishingDetected = false

        for(term in phishingTerms) {
            if ((decryptedMessage?.lowercase()?.contains(term.lowercase()) == true ||
                subject?.lowercase()?.contains(term.lowercase()) == true)
                && !phishingDetected) {
